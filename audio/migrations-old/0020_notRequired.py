...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Consignment.maximum'
        db.alter_column(u'audio_consignment', 'maximum', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Consignment.maximum'
        raise RuntimeError("Cannot reverse this migration. 'Consignment.maximum' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Consignment.maximum'
        db.alter_column(u'audio_consignment', 'maximum', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))
