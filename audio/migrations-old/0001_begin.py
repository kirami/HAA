...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.auction'
        #db.add_column(u'audio_item', 'auction',
        #              self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['audio.Auction']),
        #              keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.auction'
        db.delete_column(u'audio_item', 'auction_id')
