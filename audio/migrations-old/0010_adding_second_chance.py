...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'audio_item', 'label',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Label'], null=True),
                      keep_default=False)

        # Adding field 'Item.name'
        db.add_column(u'audio_item', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Item.record_number'
        db.add_column(u'audio_item', 'record_number',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Item.condition'
        db.add_column(u'audio_item', 'condition',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'audio_item', 'label_id')

        # Deleting field 'Item.name'
        db.delete_column(u'audio_item', 'name')

        # Deleting field 'Item.record_number'
        db.delete_column(u'audio_item', 'record_number')

        # Deleting field 'Item.condition'
        db.delete_column(u'audio_item', 'condition')
