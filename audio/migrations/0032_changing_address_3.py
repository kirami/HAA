...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.address_three'
        db.add_column(u'audio_address', 'address_three',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.address_three'
        db.delete_column(u'audio_address', 'address_three')
