...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auction.end_date'
        db.alter_column(u'audio_auction', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Auction.start_date'
        db.alter_column(u'audio_auction', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Auction.second_chance_end_date'
        db.alter_column(u'audio_auction', 'second_chance_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Auction.end_date'
        db.alter_column(u'audio_auction', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Auction.start_date'
        db.alter_column(u'audio_auction', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Auction.second_chance_end_date'
        db.alter_column(u'audio_auction', 'second_chance_end_date', self.gf('django.db.models.fields.DateField')(null=True))
