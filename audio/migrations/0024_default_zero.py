...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'audio_invoice', 'tax')

        # Deleting field 'Invoice.shipping'
        db.delete_column(u'audio_invoice', 'shipping')

        # Deleting field 'Invoice.discount'
        db.delete_column(u'audio_invoice', 'discount')

        # Deleting field 'Invoice.second_chance_shipping'
        db.delete_column(u'audio_invoice', 'second_chance_shipping')

        # Deleting field 'Invoice.second_chance_tax'
        db.delete_column(u'audio_invoice', 'second_chance_tax')

        # Deleting field 'Invoice.second_chance_invoice_amount'
        db.delete_column(u'audio_invoice', 'second_chance_invoice_amount')


    def backwards(self, orm):
        # Adding field 'Invoice.tax'
        db.add_column(u'audio_invoice', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.shipping'
        db.add_column(u'audio_invoice', 'shipping',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.discount'
        db.add_column(u'audio_invoice', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.second_chance_shipping'
        db.add_column(u'audio_invoice', 'second_chance_shipping',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.second_chance_tax'
        db.add_column(u'audio_invoice', 'second_chance_tax',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.second_chance_invoice_amount'
        db.add_column(u'audio_invoice', 'second_chance_invoice_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2, blank=True),
                      keep_default=False)
