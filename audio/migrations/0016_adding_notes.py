...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.name_two'
        db.add_column(u'audio_item', 'name_two',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.notes'
        db.add_column(u'audio_item', 'notes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.name_two'
        db.delete_column(u'audio_item', 'name_two')

        # Deleting field 'Item.notes'
        db.delete_column(u'audio_item', 'notes')
