...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.second_chance_start_date'
        db.add_column(u'audio_auction', 'second_chance_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.second_chance_start_date'
        db.delete_column(u'audio_auction', 'second_chance_start_date')
