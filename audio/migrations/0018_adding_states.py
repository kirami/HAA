...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'audio_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Address.state'
        db.alter_column(u'audio_address', 'state', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
