...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrintedCatalog'
        db.create_table(u'audio_printedcatalog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('auction', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'audio', ['PrintedCatalog'])


    def backwards(self, orm):
        # Deleting model 'PrintedCatalog'
        db.delete_table(u'audio_printedcatalog')
