...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.shipped_date'
        db.add_column(u'audio_invoice', 'shipped_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Invoice.on_hold'
        db.add_column(u'audio_invoice', 'on_hold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.shipped_date'
        db.delete_column(u'audio_invoice', 'shipped_date')

        # Deleting field 'Invoice.on_hold'
        db.delete_column(u'audio_invoice', 'on_hold')
