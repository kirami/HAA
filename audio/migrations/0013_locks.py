...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'audio_auction', 'locked')

        # Adding field 'Auction.blind_locked'
        db.add_column(u'audio_auction', 'blind_locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Auction.flat_locked'
        db.add_column(u'audio_auction', 'flat_locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'audio_auction', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Auction.blind_locked'
        db.delete_column(u'audio_auction', 'blind_locked')

        # Deleting field 'Auction.flat_locked'
        db.delete_column(u'audio_auction', 'flat_locked')
