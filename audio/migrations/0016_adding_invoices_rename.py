...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.quanity'
        db.delete_column(u'audio_item', 'quanity')

        # Adding field 'Item.quantity'
        db.add_column(u'audio_item', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.quanity'
        db.add_column(u'audio_item', 'quanity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Item.quantity'
        db.delete_column(u'audio_item', 'quantity')
    ...
    models = {
        ...
        u'audio.payments': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['audio.Invoices']"}),
