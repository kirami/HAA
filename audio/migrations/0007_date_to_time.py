...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bid.date'
        db.alter_column(u'audio_bid', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Bid.date_received'
        raise RuntimeError("Cannot reverse this migration. 'Bid.date_received' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Bid.date_received'
        ...
        # Changing field 'Bid.date'
        db.alter_column(u'audio_bid', 'date', self.gf('django.db.models.fields.DateField')())
