...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'audio_userprofile', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.confirmation_code'
        db.add_column(u'audio_userprofile', 'confirmation_code',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'audio_userprofile', 'verified')

        # Deleting field 'UserProfile.confirmation_code'
        db.delete_column(u'audio_userprofile', 'confirmation_code')
