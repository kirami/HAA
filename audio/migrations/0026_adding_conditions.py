...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'audio_condition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('auction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Auction'])),
            ('message', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ))
        db.send_create_signal(u'audio', ['Condition'])


    def backwards(self, orm):
        # Deleting model 'Condition'
        db.delete_table(u'audio_condition')
