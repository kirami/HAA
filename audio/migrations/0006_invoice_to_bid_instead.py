...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.invoice'
        db.delete_column(u'audio_item', 'invoice_id')

        # Adding field 'Bid.date_received'
        db.add_column(u'audio_bid', 'date_received',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None, blank=True),
                      keep_default=False)

        # Adding field 'Bid.invoice'
        db.add_column(u'audio_bid', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Invoice'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Payment.received_date'
        db.delete_column(u'audio_payment', 'received_date')

        # Adding field 'Payment.date_received'
        db.add_column(u'audio_payment', 'date_received',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.invoice'
        db.add_column(u'audio_item', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Invoice'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Bid.date_received'
        db.delete_column(u'audio_bid', 'date_received')

        # Deleting field 'Bid.invoice'
        db.delete_column(u'audio_bid', 'invoice_id')


        # User chose to not deal with backwards NULL issues for 'Payment.received_date'
        raise RuntimeError("Cannot reverse this migration. 'Payment.received_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Payment.received_date'
        db.add_column(u'audio_payment', 'received_date',
                      self.gf('django.db.models.fields.DateField')(),
                      keep_default=False)

        # Deleting field 'Payment.date_received'
        db.delete_column(u'audio_payment', 'date_received')
