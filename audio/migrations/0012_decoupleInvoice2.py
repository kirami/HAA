...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bid.invoice'
        db.alter_column(u'audio_bid', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Invoice'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Bid.invoice'
        db.alter_column(u'audio_bid', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audio.Invoice'], null=True))
