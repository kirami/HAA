...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'audio_item', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Item.thumbnail'
        db.alter_column(u'audio_item', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
        # Adding field 'Auction.name'
        db.add_column(u'audio_auction', 'name',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.image'
        db.alter_column(u'audio_item', 'image', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))

        # Changing field 'Item.thumbnail'
        db.alter_column(u'audio_item', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
        # Deleting field 'Auction.name'
        db.delete_column(u'audio_auction', 'name')
