...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.auction'
        db.add_column(u'audio_category', 'auction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['audio.Auction']),
                      keep_default=False)

        # Adding field 'Category.order_number'
        db.add_column(u'audio_category', 'order_number',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.auction'
        db.delete_column(u'audio_category', 'auction_id')

        # Deleting field 'Category.order_number'
        db.delete_column(u'audio_category', 'order_number')
