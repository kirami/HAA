...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.discount_percent'
        db.add_column(u'audio_invoice', 'discount_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.discount_percent'
        db.delete_column(u'audio_invoice', 'discount_percent')
