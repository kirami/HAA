...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'audio_itemtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('notes', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'audio', ['ItemType'])

        # Adding field 'Item.item_type'
        db.add_column(u'audio_item', 'item_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='itemType', to=orm['audio.ItemType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ItemType'
        db.delete_table(u'audio_itemtype')

        # Deleting field 'Item.item_type'
        db.delete_column(u'audio_item', 'item_type_id')
