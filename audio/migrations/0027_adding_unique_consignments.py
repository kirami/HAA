...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.create_unique(u'audio_userprofile', ['user_id'])

        # Adding unique constraint on 'Consignment', fields ['maximum', 'item']
        db.create_unique(u'audio_consignment', ['maximum', 'item_id'])

        # Adding unique constraint on 'Consignment', fields ['minimum', 'item']
        db.create_unique(u'audio_consignment', ['minimum', 'item_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Consignment', fields ['minimum', 'item']
        db.delete_unique(u'audio_consignment', ['minimum', 'item_id'])

        # Removing unique constraint on 'Consignment', fields ['maximum', 'item']
        db.delete_unique(u'audio_consignment', ['maximum', 'item_id'])

        # Removing unique constraint on 'UserProfile', fields ['user']
        #db.delete_unique(u'audio_userprofile', ['user_id'])
