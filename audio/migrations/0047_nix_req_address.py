...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.billing_address'
        db.alter_column(u'audio_userprofile', 'billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['audio.Address']))

        # Changing field 'UserProfile.shipping_address'
        db.alter_column(u'audio_userprofile', 'shipping_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['audio.Address']))

    def backwards(self, orm):

        # Changing field 'UserProfile.billing_address'
        db.alter_column(u'audio_userprofile', 'billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['audio.Address']))

        # Changing field 'UserProfile.shipping_address'
        db.alter_column(u'audio_userprofile', 'shipping_address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['audio.Address']))
    ...
    models = {
        ...
        u'audio.category': {
            ...
            'order_number': ('django.db.models.fields.IntegerField', [], {'default': 'None'})
        },
        u'audio.condition': {
        ...
        u'audio.item': {
            ...
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['audio.Label']", 'null': 'True', 'blank': 'True'}),
        ...
        u'audio.userprofile': {
            ...
            'billing_address': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'upBilling'", 'null': 'True', 'to': u"orm['audio.Address']"}),
            ...
            'shipping_address': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'upShipping'", 'null': 'True', 'to': u"orm['audio.Address']"}),
