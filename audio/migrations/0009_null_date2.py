...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'audio_invoice', 'second_chance_invoice_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Invoice.second_chance_invoice_amount'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.second_chance_invoice_amount' and its values cannot be restored.")
