...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.shipping_address'
        db.add_column(u'audio_userprofile', 'shipping_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='upShipping', to=orm['audio.Address']),
                      keep_default=False)

        # Adding field 'UserProfile.billing_address'
        db.add_column(u'audio_userprofile', 'billing_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='upBilling', to=orm['audio.Address']),
                      keep_default=False)

        # Deleting field 'Address.user'
        db.delete_column(u'audio_address', 'user_id')

        # Deleting field 'Address.cell_phone'
        db.delete_column(u'audio_address', 'cell_phone')


        # Changing field 'Address.telephone'
        db.alter_column(u'audio_address', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'UserProfile.shipping_address'
        db.delete_column(u'audio_userprofile', 'shipping_address_id')

        # Deleting field 'UserProfile.billing_address'
        db.delete_column(u'audio_userprofile', 'billing_address_id')

        # Adding field 'Address.user'
        db.add_column(u'audio_address', 'user',
        ...
        # Changing field 'Address.telephone'
        db.alter_column(u'audio_address', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
