...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'audio_address', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Address.zipcode'
        db.alter_column(u'audio_address', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Address.city'
        raise RuntimeError("Cannot reverse this migration. 'Address.city' and its values cannot be restored.")
