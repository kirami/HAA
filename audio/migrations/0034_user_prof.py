...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.printed_list'
        db.delete_column(u'audio_userprofile', 'printed_list')

        # Deleting field 'UserProfile.email_invoice'
        db.delete_column(u'audio_userprofile', 'email_invoice')

        # Adding field 'UserProfile.email_only'
        db.add_column(u'audio_userprofile', 'email_only',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.quiet'
        db.add_column(u'audio_userprofile', 'quiet',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.printed_list'
        db.add_column(u'audio_userprofile', 'printed_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.email_invoice'
        db.add_column(u'audio_userprofile', 'email_invoice',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UserProfile.email_only'
        db.delete_column(u'audio_userprofile', 'email_only')

        # Deleting field 'UserProfile.quiet'
        db.delete_column(u'audio_userprofile', 'quiet')
    ...
    models = {
        ...
        u'audio.item': {
            ...
            'defect': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
