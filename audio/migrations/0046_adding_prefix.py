...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.post_script'
        db.delete_column(u'audio_item', 'post_script')

        # Adding field 'Item.prefix'
        db.add_column(u'audio_item', 'prefix',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.post_script'
        db.add_column(u'audio_item', 'post_script',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Item.prefix'
        db.delete_column(u'audio_item', 'prefix')
