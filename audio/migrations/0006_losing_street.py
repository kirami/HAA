...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'audio_address', 'street')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Address.street'
        raise RuntimeError("Cannot reverse this migration. 'Address.street' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Address.street'
        db.add_column(u'audio_address', 'street',
