...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.defect'
        db.alter_column(u'audio_item', 'defect', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Item.defect'
        db.alter_column(u'audio_item', 'defect', self.gf('django.db.models.fields.CharField')(max_length=100))
