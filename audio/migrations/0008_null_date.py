...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.second_chance_invoice_date'
        db.alter_column(u'audio_invoice', 'second_chance_invoice_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Invoice.reminder_invoice_date'
        db.alter_column(u'audio_invoice', 'reminder_invoice_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Invoice.second_chance_invoice_amount'
        db.alter_column(u'audio_invoice', 'second_chance_invoice_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Invoice.second_chance_invoice_date'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.second_chance_invoice_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Invoice.second_chance_invoice_date'
        db.alter_column(u'audio_invoice', 'second_chance_invoice_date', self.gf('django.db.models.fields.DateField')())

        # User chose to not deal with backwards NULL issues for 'Invoice.reminder_invoice_date'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.reminder_invoice_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Invoice.reminder_invoice_date'
        db.alter_column(u'audio_invoice', 'reminder_invoice_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Invoice.second_chance_invoice_amount'
        db.alter_column(u'audio_invoice', 'second_chance_invoice_amount', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'audio.bid': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['audio.Invoice']", 'null': 'True', 'blank': 'True'}),
        ...
        u'audio.invoice': {
            ...
            'second_chance_invoice_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
