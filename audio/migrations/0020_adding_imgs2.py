...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.thumbnail'
        db.add_column(u'audio_item', 'thumbnail',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'Item.image'
        db.add_column(u'audio_item', 'image',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.thumbnail'
        db.delete_column(u'audio_item', 'thumbnail')

        # Deleting field 'Item.image'
        db.delete_column(u'audio_item', 'image')
