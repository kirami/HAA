 ...
 *
 * Visit us at http://www.dotlaunch.com/ for updates and more information.
 *
 ...
 ***  Visit www.dotlaunch.com for free <a href="http://www.dotlaunch.com/">FormMail</a>.
 *
 ...
 *      http://www.dotlaunch.com/fmdoc/index.php
 *
 * Purpose:
 * ~~~~~~~~
 ...
 *	usage and features.  We have HOW-TO guides at www.dotlaunch.com which
 *	describe many of the advanced processing you can do with FormMail.
 *      http://www.dotlaunch.com/fmhowto/guides.php
 *
 * Quicker Start
 * ~~~~~~~~~~~~~
 *  Use the FormMail Configuration Wizard here:
 *      http://www.dotlaunch.com/wizards/fmconf.php
 ...
 * Features
 * ~~~~~~~~
 *  For a list of features go to: http://www.dotlaunch.com/formmailpage.php
 *
 * Security
 * ~~~~~~~~
 ...
 *  Tectite FormMail: http://www.dotlaunch.com/fmdoc/creating_forms.php
 *
 * Copying and Use
 * ~~~~~~~~~~~~~~~
 ...
 *      http://www.dotlaunch.com/vbforums/
 *  or view our contact information:
 *      http://www.dotlaunch.com/contacts.php
 *
 * Version History
 * ~~~~~~~~~~~~~~~
 ...
 *	main website here:
 *	 http://www.dotlaunch.com/fmdoc/version_history.php
 */
...
/* Help: http://www.dotlaunch.com/fmdoc/email_name.php */
define("EMAIL_NAME","^[-a-z0-9.]+");	// the '^' is an important security feature!

/* Help: http://www.dotlaunch.com/fmdoc/target_email.php */
$TARGET_EMAIL = array(EMAIL_NAME."@thoseoldrecords\.com$",
    EMAIL_NAME."@dotlaunch\.com$",
    ); 

/* Help: http://www.dotlaunch.com/fmdoc/def_alert.php */
define("DEF_ALERT","hawthorn@thoseoldrecords.com");

/* Help: http://www.dotlaunch.com/fmdoc/set_real_document_root.php */
...
if (isset($SET_REAL_DOCUMENT_ROOT) && $SET_REAL_DOCUMENT_ROOT !== "")
    $REAL_DOCUMENT_ROOT = $SET_REAL_DOCUMENT_ROOT;
			...
			/* Help: http://www.dotlaunch.com/fmdoc/config_check.php */
$CONFIG_CHECK = array("TARGET_EMAIL");

			/* Help: http://www.dotlaunch.com/fmdoc/at_mangle.php */
define("AT_MANGLE","");

			/* Help: http://www.dotlaunch.com/fmdoc/target_urls.php */
$TARGET_URLS = array();			// default; no URLs allowed

			/* Help: http://www.dotlaunch.com/fmdoc/head_crlf.php */
define("HEAD_CRLF","\n");

			/* Help: http://www.dotlaunch.com/fmdoc/body_lf.php */
define("BODY_LF","\r\n");		// the new default: use this for CR+LF
//define("BODY_LF","\n");		// the old default: just LF

			/* Help: http://www.dotlaunch.com/fmdoc/from_user.php */
$FROM_USER = "HawthornsAntiqueAudio";                            // the default - setting not used

			/* Help: http://www.dotlaunch.com/fmdoc/sendmail_f_option.php */
define("SENDMAIL_F_OPTION",false);
define("SENDMAIL_F_OPTION_LINE",__LINE__-1);    // don't modify this line!

			/* Help: http://www.dotlaunch.com/fmdoc/set_sender_from_email.php */
define("SET_SENDER_FROM_EMAIL",false);

			/* Help: http://www.dotlaunch.com/fmdoc/ini_set_from.php */
define("INI_SET_FROM",false);

			/* Help: http://www.dotlaunch.com/fmdoc/logdir.php */
$LOGDIR = "";							// directory for log files; empty string to
										// disallow log files
			/* Help: http://www.dotlaunch.com/fmdoc/autorespondlog.php */
$AUTORESPONDLOG = "";			// file name in $LOGDIR for the auto responder
								// log; empty string for no auto responder log

			/* Help: http://www.dotlaunch.com/fmdoc/csv_file_settings.php */
$CSVDIR = "/target/apacheweb/domains/thoseoldrecords.com/htdocs/bids/";		// directory for csv files; empty string to disallow csv files
...
$CSVLINE = "\n";	// line termination for CSV files.  The default is
			...
			/* Help: http://www.dotlaunch.com/fmdoc/templatedir.php */
$TEMPLATEDIR = "/target/apacheweb/domains/thoseoldrecords.com/htdocs/bids/templates";					// directory for template files; empty string
									// if you don't have any templates

			/* Help: http://www.dotlaunch.com/fmdoc/templateurl.php */
$TEMPLATEURL = "";					// default; no template URL

			/* Help: http://www.dotlaunch.com/fmdoc/multiformdir.php */
$MULTIFORMDIR = "";			// directory for multi-form template files; empty string
						    // if you're not using multi-forms

			/* Help: http://www.dotlaunch.com/fmdoc/multiformurl.php */
$MULTIFORMURL = "";					// default; no multi-forms templates URL

			/* Help: http://www.dotlaunch.com/fmdoc/authentication_settings.php */
$AUTHENTICATE = "";
//$AUTHENTICATE = "Basic cnVzc2VsbHI6dGVzdA==";        // example
$AUTH_USER = "";
$AUTH_PW = "";

			/* Help: http://www.dotlaunch.com/fmdoc/form_ini_file.php */
$FORM_INI_FILE = "/target/apacheweb/domains/thoseoldrecords.com/htdocs/bids/bids.ini";

			/* Help: http://www.dotlaunch.com/fmdoc/moduledir.php */
$MODULEDIR = ".";

			/* Help: http://www.dotlaunch.com/fmdoc/fmcompute.php */
$FMCOMPUTE = "fmcompute.php";

			/* Help: http://www.dotlaunch.com/fmdoc/fmgeoip.php */
$FMGEOIP = "fmgeoip.php";

			/* Help: http://www.dotlaunch.com/fmdoc/advanced_templates.php */
define("ADVANCED_TEMPLATES",false);		// set to true for advanced templates

			/* Help: http://www.dotlaunch.com/fmdoc/limited_import.php */
define("LIMITED_IMPORT",true);		// set to true if your database cannot
			...
			/* Help: http://www.dotlaunch.com/fmdoc/valid_env.php */
$VALID_ENV = array('HTTP_REFERER','REMOTE_HOST','REMOTE_ADDR','REMOTE_USER',
				'HTTP_USER_AGENT');

			/* Help: http://www.dotlaunch.com/fmdoc/fileuploads.php */
define("FILEUPLOADS",false);		// set to true to allow file attachments

			/* Help: http://www.dotlaunch.com/fmdoc/max_file_upload_size.php */
define("MAX_FILE_UPLOAD_SIZE",0);		// default of 0 means that other software
			...
			/* Help: http://www.dotlaunch.com/fmdoc/file_repository.php */
$FILE_REPOSITORY = "";

			/* Help: http://www.dotlaunch.com/fmdoc/file_mode.php */
define("FILE_MODE",0664);     // always precede with 0 to specify octal!

			/* Help: http://www.dotlaunch.com/fmdoc/file_overwrite.php */
define("FILE_OVERWRITE",true);

			/* Help: http://www.dotlaunch.com/fmdoc/next_num_file.php */
$NEXT_NUM_FILE = "";

			/* Help: http://www.dotlaunch.com/fmdoc/put_data_in_url.php */
define("PUT_DATA_IN_URL",true);	// set to true to place data in the URL
									// for bad_url redirects

			/* Help: http://www.dotlaunch.com/fmdoc/db_see_input.php */
define("DB_SEE_INPUT",false);		// set to true to just see the input values

			/* Help: http://www.dotlaunch.com/fmdoc/db_see_ini.php */
define("DB_SEE_INI",false);		// set to true to just see the ini file

			/* Help: http://www.dotlaunch.com/fmdoc/maxstring.php */
define("MAXSTRING",10024);         	// maximum string length for a value

			/* Help: http://www.dotlaunch.com/fmdoc/bshowmesgnumbers.php */
$bShowMesgNumbers = false;

			/* Help: http://www.dotlaunch.com/fmdoc/filters.php */
$FILTERS = array("encode"=>"$REAL_DOCUMENT_ROOT/cgi-bin/fmencoder -kpubkey.txt",
                "null"=>"null");

			/* Help: http://www.dotlaunch.com/fmdoc/socket_filters.php */
$SOCKET_FILTERS = array(
			...
			/* Help: http://www.dotlaunch.com/fmdoc/filter_attribs.php */
$FILTER_ATTRIBS = array("encode"=>"Strips,MIME=text/plain",
						"httpencode"=>"Strips,MIME=text/plain",
						"sslencode"=>"Strips,MIME=text/plain",);

			/* Help: http://www.dotlaunch.com/fmdoc/check_for_new_version.php */
define("CHECK_FOR_NEW_VERSION",false);
define("CHECK_DAYS",30);

			/* Help: http://www.dotlaunch.com/fmdoc/scratch_pad.php */
$SCRATCH_PAD = "";

			/* Help: http://www.dotlaunch.com/fmdoc/cleanup_time.php */
$CLEANUP_TIME = 60;     // cleanup time in minutes

			/* Help: http://www.dotlaunch.com/fmdoc/cleanup_chance.php */
$CLEANUP_CHANCE = 20;     // percentage probability that cleanup will be performed

			/* Help: http://www.dotlaunch.com/fmdoc/pear_settings.php */
$PEAR_SMTP_HOST = "";
$PEAR_SMTP_PORT = 25;
$PEAR_SMTP_USER = "";
$PEAR_SMTP_PWD = "";

			/* Help: http://www.dotlaunch.com/fmdoc/alert_on_user_error.php */
define("ALERT_ON_USER_ERROR",true);

			/* Help: http://www.dotlaunch.com/fmdoc/enable_attack_detection.php */
define("ENABLE_ATTACK_DETECTION",true);

			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_url.php */
define("ATTACK_DETECTION_URL","");

			/* Help: http://www.dotlaunch.com/fmdoc/alert_on_attack_detection.php */
define("ALERT_ON_ATTACK_DETECTION",false);

			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_mime.php */
define("ATTACK_DETECTION_MIME",true);

			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_dups.php */
$ATTACK_DETECTION_DUPS = array();

			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_specials.php */
...
$ATTACK_DETECTION_SPECIALS_ANY_EMAIL = array("subject");
			...
			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_many_urls.php */
define("ATTACK_DETECTION_MANY_URLS",0);

			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_many_url_fields.php */
define("ATTACK_DETECTION_MANY_URL_FIELDS",0);

			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_url_patterns.php */
$ATTACK_DETECTION_URL_PATTERNS = array(
			...
			/* Help: http://www.dotlaunch.com/fmdoc/attack_detection_ignore_errors.php */
define("ATTACK_DETECTION_IGNORE_ERRORS",false);

			/* Help: http://www.dotlaunch.com/fmdoc/geoip_lic.php */
$GEOIP_LIC = "";        // default - no GeoIP

			/* Help: http://www.dotlaunch.com/fmdoc/zero_is_empty.php */
define("ZERO_IS_EMPTY",false);

			/* Help: http://www.dotlaunch.com/fmdoc/session_name.php */
$SESSION_NAME = "";

			/* Help: http://www.dotlaunch.com/fmdoc/hook_dir.php */
$HOOK_DIR = "";
...
function LoadBuiltinLanguage()
{
	...
	$aMessages[MSG_OPEN_TEMPLATE] = 'Failed to open template "$NAME" $MNUM: $ERROR';
		...
		// Parameters: none
	$aMessages[MSG_ERROR_PROC] = '<font face="Arial">An error occurred while processing the '.
								 'form</font> $MNUM.\n\n';
	...
	$aMessages[MSG_APOLOGY] = 'We apologize for any inconvenience this error '.
		...
		//	$TECTITE	www.dotlaunch.com
	$aMessages[MSG_ABOUT_FORMMAIL] = '<font face="Arial">Please use the back button on your browser to return to the form and try again.</font> ';
	...
	$aMessages[MSG_NO_DATA_PAGE] =	'This URL is a Form submission program.\n'.
		...
		// Parameters: none
	$aMessages[MSG_REQD_ERROR] = '<font face="Arial">The form required some values that you '.
								 'did not seem to provide.</font><br>';
	...
	$aMessages[MSG_ATTACK_PAGE] = 'Your form submission has been rejected '.
                                  ...
                                  '<a href="http://www.dotlaunch.com/serverabuse.php" '.
                                  ' target="_blank">'.
                                  'www.dotlaunch.com/serverabuse.php</a>.';
...
$EMAIL_ADDRS = array();
	...
	//
	// Access the www.dotlaunch.com website to get the current version.
	//
function CheckVersion()
{
	global	$FM_VERS;

@	$fp = fopen("http://www.dotlaunch.com/fmversion.txt","r");
	if ($fp !== false)
	{
			//
...
function OnExit()
{
	global	$TARGET_EMAIL,$CHECK_FILE;
		...
		//
		// Check the www.dotlaunch.com website for a new version, but only
...
function GetURL($s_url,&$s_error)
{
	...
	fputs($f_sock,"Host: $s_host_hdr\r\n");
        ...
        //
	fputs($f_sock,"User-Agent: FormMail/$FM_VERS (from www.dotlaunch.com)\r\n");
        //
        // Accept any output
        //
	fputs($f_sock,"Accept: */*\r\n");
					...
					$a_attach_spec = array())
{
	...
	$a_headers['MIME-Version'] = "1.0 (produced by FormMail $FM_VERS from www.dotlaunch.com)";
