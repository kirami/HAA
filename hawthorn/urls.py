...
urlpatterns = patterns('',
    ...
    url(r'^admin/printLoserLetters/(?P<auctionId>\d+)/$', admin_views.printLoserLetters, name='printLoserLetters'),
    url(r'^admin/invoices/(?P<auctionId>\d+)/$', admin_views.invoices, name='invoices'),
    url(r'^admin/loserLetters/(?P<auctionId>\d+)/$', admin_views.loserLetters, name='loserLetters'),
    ...
    url(r'^admin/printRecordLabels/(?P<auctionId>\d+)/(?P<startingIndex>\d+)/(?P<endIndex>\d+)/$', admin_views.printRecordLabels, name='printRecordLabels'),
